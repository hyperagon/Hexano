class Bell extends Instrument {
    ...
    createBellControls() {
        ...
        bellControls.style.backgroundColor = 'rgba(0,0,0,0.2)';
        bellControls.style.padding = '5px 10px';
        bellControls.style.borderRadius = '4px';
        ...
        decayLabel.textContent = 'Decay: 1.5s';
        decayLabel.id = 'bell-decay-label';
        decayLabel.style.display = 'block';
        decayLabel.style.fontSize = '0.75em';
        decayLabel.style.marginBottom = '2px';
        decayLabel.style.color = '#ddd';
        ...
        decaySlider.addEventListener('input', function() {
            document.getElementById('bell-decay-label').textContent = 'Decay: ' + this.value + 's';
        });
        ...
        var harmLabel = document.createElement('label');
        harmLabel.textContent = 'Brightness';
        harmLabel.style.display = 'block';
        harmLabel.style.fontSize = '0.75em';
        harmLabel.style.marginBottom = '2px';
        harmLabel.style.color = '#ddd';
        ...
        harmGroup.appendChild(harmLabel);
